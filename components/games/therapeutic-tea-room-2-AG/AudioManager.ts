...
export class AudioManager {
  ...
  playMemoryCue() {
    this.softTone(392, 0.18, "sine", 0.045);
    this.softTone(523, 0.2, "sine", 0.035, 0.1);
  }

  playMemoryArrival() {
    this.softTone(494, 0.18, "sine", 0.05);
    this.softTone(659, 0.24, "sine", 0.04, 0.08);
  }

  playMemoryReveal(correct: boolean) {
    if (correct) {
      this.softTone(523, 0.18, "sine", 0.05);
      this.softTone(659, 0.25, "sine", 0.045, 0.09);
      return;
    }
    this.softTone(392, 0.2, "sine", 0.045);
    this.softTone(494, 0.2, "sine", 0.035, 0.1);
  }
