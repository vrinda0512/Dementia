...
import { memoryCategories, memoryQuestions } from "./memoryData";
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#dff3e5]">
      ...
      <header className="relative z-20 px-6 py-5 md:px-10">
        <div className="mx-auto flex max-w-7xl items-center justify-between">
          <div>
            ...
            <h1 className="mt-1 text-3xl font-bold text-slate-800 md:text-4xl">
              Memory Map
            </h1>
      ...
      <section className="relative mx-auto h-[calc(100vh-125px)] min-h-[650px] max-w-7xl overflow-hidden px-4 pb-8 md:px-8">
        ...
        {/* Clouds */}
        <div className="absolute left-[8%] top-[7%] text-5xl opacity-70">
          ☁️
        </div>

        <div className="absolute right-[12%] top-[10%] text-4xl opacity-60">
          ☁️
        </div>
        ...
        {memoryCategories.map((category) => {
          const questionCount = memoryQuestions.filter(
          ...
          return (
            <button
              ...
              className={`group absolute z-20 ${category.position} flex h-32 w-32 flex-col items-center justify-center rounded-[50%] bg-gradient-to-br ${category.color} p-4 text-center text-white shadow-xl transition-all duration-300 hover:-translate-y-2 hover:scale-105 hover:shadow-2xl active:scale-95 md:h-40 md:w-40`}
            >
        ...
        {/* Decorative trees */}
        <div className="absolute bottom-[16%] left-[4%] text-5xl">
          🌳
        </div>

        <div className="absolute bottom-[23%] right-[5%] text-5xl">
          🌳
        </div>

        <div className="absolute bottom-[8%] right-[38%] text-4xl">
          🌲
        </div>
